...
- **보존 경로**: 기존 V3 `조선 인플레이션 RPG`는
  ...
  유지한다.
- **현재 검증**: game Vitest 398개 파일·3,463개 테스트, V4 E2E 30/30, game E2E 44/44
  (Chromium 22/22·iPhone14 22/22), dev-shell portal E2E 5/5, root test/typecheck/lint/circular/build 통과.
...
기존 V3는 **조선 인플레이션 RPG (Legacy)** 경로로 별도 실행할 수 있다.
