...
describe('Village hero detail screen', () => {
  ...
  it('does not expose non-finite hero or equipment values', () => {
    const save = createInitialVillageSave(128);
    const hero = {
      ...save.run.hero,
      age: Number.NaN,
  ...
  it('does not expose negative hero values from an in-memory malformed snapshot', () => {
    const save = createInitialVillageSave(129);
    const hero = {
      ...save.run.hero,
      hp: -50,
      hpMax: -100,
  ...
  it('keeps the hero detail usable when the equipment collection is malformed', () => {
    const save = createInitialVillageSave(131);
  ...
  it('caps an unsafe hero age before rendering the detail header', () => {
    const save = createInitialVillageSave(130);
