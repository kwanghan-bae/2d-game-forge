...
export class EncounterEngine {
  ...
  private applyPendingEvents(r: PostCombatResult, hero: HeroEntity, events: OverworldEvent[]): void {
    ...
    if (r.eventType && !r.merchantPending && !r.gamblerPending && !r.altarPending && !r.riskGambitPending && !r.wanderingMerchantPending && !r.sparringGroundsPending) {
