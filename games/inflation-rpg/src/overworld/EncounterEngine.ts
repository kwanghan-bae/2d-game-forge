    ...
    if (r.wanderingMerchantPending) {
      ...
      if (needsHeal) {
        ...
        if (this.rng.chance(WANDERING_MERCHANT_GAMBLE_WIN_RATE)) {
          ...
          events.push({ type: 'event_wandering_merchant', choice: 'gamble_lose', value: 0 });
        }
      } else {
