...
export class EncounterEngine {
  ...
  private applyEventResolve(id: 'colosseum' | 'trial_grounds' | 'storm_nexus' | 'rain_sanctuary' | 'fog_ambush' | 'wind_gale' | 'snow_drift' | 'void_rift' | 'abyssal_convergence' | 'temporal_fissure' | 'titan_arena', accept: boolean): void {
      ...
      while (eHp > 0 && !hero.staggered && hitCount < MAX_COMBAT_TURNS) {
        ...
        if (eHp > 0) {
          ...
          const totalDrMul = computeDamageReduction({
            ...
            titanArenaActive: this.titanArenaRemaining > 0,
          });
