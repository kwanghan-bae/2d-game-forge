...
export class EncounterEngine {
  ...
  private applyEventResolve(id: 'colosseum' | 'trial_grounds' | 'storm_nexus' | 'rain_sanctuary' | 'fog_ambush' | 'wind_gale' | 'snow_drift' | 'void_rift' | 'abyssal_convergence' | 'temporal_fissure', accept: boolean): void {
