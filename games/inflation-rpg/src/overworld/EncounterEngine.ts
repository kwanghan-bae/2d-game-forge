    ...
    if (r.wanderingMerchantPending) {
      ...
      if (needsHeal) {
        ...
        if (this.rng.chance(WANDERING_MERCHANT_GAMBLE_WIN_RATE)) {
          ...
          // C847: consolation gold on gamble loss
          hero.gold += WANDERING_MERCHANT_GAMBLE_LOSS_GOLD;
          events.push({ type: 'event_wandering_merchant', choice: 'gamble_lose', value: WANDERING_MERCHANT_GAMBLE_LOSS_GOLD });
        }
      } else {
