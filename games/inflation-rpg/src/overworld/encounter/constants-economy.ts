...
export const CHAIN_LIGHTNING_DMG_RATE = 0.10; // C649: was 0.20. Free damage from combo too generous
export const PRESTIGE_GOLD_BONUS_PER_LEVEL = 5;
export const LUCKY_CRIT_CHANCE = 0.05;
export const LUCKY_CRIT_MUL = 2.0; // C644: was 3.0. Super-crit damage reduced
...
export const ADRENALINE_ATK_BONUS = 0.15; // C647: was 0.30. Stacks with berserker, too much
...
export const REGEN_BUFF_MUL = 1.5; // C715: was 2.0, late-game heal overflow prevention
...
export const COMBO_PRESTIGE_ATK_FLAT = 3;
