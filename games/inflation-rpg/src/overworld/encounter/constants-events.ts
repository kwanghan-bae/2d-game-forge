...
export const VETERANS_TRIAL_AGG_ATK_MUL = 0.30; // C903: 0.25→0.30 (VT_AGG EV parity with DEF)
export const VETERANS_TRIAL_AGG_DURATION = 12; // C903: 10→12 (AGG net benefit 2.50→3.60)
...
// C921: Wandering Sage — mid-late repeatable (fight 260-450, 4%, EXP boost)
export const WANDERING_SAGE_MIN_FIGHTS = 260;
export const WANDERING_SAGE_MAX_FIGHTS = 450; // C924: 400→450 (fill fight 400-450 desert)
...
export const INFLATION_CASH_OUT_GOLD_MUL = 50; // C989: gold per level on cash-out choice
