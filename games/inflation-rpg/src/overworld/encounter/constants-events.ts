...
export const GAMBLER_WIN_RATE = 0.45; // C702: was 0.50, slight negative EV for risk
...
export const CURSED_ALTAR_DAMAGE_MUL = 2.0; // C696: was 3.0, less lethal
export const CURSED_ALTAR_DURATION = 10; // C696: was 15, shorter curse
