...
const NPC_DEATH_VARIANTS_BY_KIND: Record<NpcEntity['kind'], Array<(c: { age: number }) => string>> = {
  mentor: [
    ...
    (c) => `${c.age}세에 멘토는 영원한 학생에게 마지막 책의 페이지를 덮었다.`,
  ],
  rival: [
