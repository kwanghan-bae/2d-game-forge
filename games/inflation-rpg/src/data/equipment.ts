...
export const EQUIPMENT_BASES: EquipmentBase[] = [
  ...
  { id: 'acc-burst-charm', name: '폭발부적',   slot: 'accessory', rarity: 'epic',      baseStats: { flat: { luc: 80 }, percent: { luc: 50 } }, dropAreaIds: ['volcano-core'],     price: 12000, specialEffect: { type: 'burst_chance', bonus: 20 } },
  ...
  { id: 'w-exp-katana',    name: '수련도',     slot: 'weapon',    rarity: 'epic',      baseStats: { flat: { atk: 200 } },   dropAreaIds: ['sacred-mountain'],  price: 9000,  specialEffect: { type: 'exp_bonus', percent: 10 } },
