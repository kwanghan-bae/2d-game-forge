...
export const CHARACTERS: Character[] = [
  ...
  // ── 공격형 (soul grade 2~4) ──
  {
    ...
    unlockSoulGrade: 2,
    activeSkills: SKILLS.tiger_hunter,
  },
  {
