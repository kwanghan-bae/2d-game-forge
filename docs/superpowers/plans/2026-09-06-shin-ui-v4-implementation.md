...
- 오프라인 결과 모달에 제목 기반 `aria-labelledby`와 Escape 닫기 경계를 추가해 키보드 복귀 경로를 보장하고 컴포넌트 회귀 테스트로 고정했다.
...
- 전체 게임 단위/컴포넌트 테스트(V4 포함): 397개 파일, 3,398개 테스트 통과.
