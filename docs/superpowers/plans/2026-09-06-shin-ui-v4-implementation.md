...
- 활성 원정 중 V3 영웅 가져오기를 비활성화해 전투 중 영웅 스냅샷 교체를 막고, 귀환 후 명시적 import만 허용하도록 화면 회귀 테스트를 추가했다.
...
- 전체 게임 단위/컴포넌트 테스트(V4 포함): 397개 파일, 3,435개 테스트 통과.
